...
export default function PatientMessagesPage({ userId, senderDisplayName, initialPeer, onOpenCareTeamSettings, onlineUsers = {} }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Fetch ALL unread messages for this patient (no sender filter - handled in JS).
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                        ...
                        <span style={{
                          display: "inline-block", fontSize: 9, fontWeight: 700, padding: "1px 5px", borderRadius: 99, flexShrink: 0,
                          background: item.type === "doctor" ? "rgba(37,99,235,.12)" : "rgba(124,58,237,.12)",
                          color: item.type === "doctor" ? "var(--p)" : "#7c3aed",
