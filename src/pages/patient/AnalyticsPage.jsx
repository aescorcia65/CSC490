    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMob ? "16px 14px 56px" : "28px 24px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMob ? "1fr" : "1fr 1fr", gap: 16, marginBottom: 20 }}>
          <motion.div className="au" style={{ ...cardBase, padding: 22, position: "relative", overflow: "hidden" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <Sparkles size={22} color="#9333ea" />
              <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: t1 }}>Insights</h3>
            </div>
            <ul style={{ margin: 0, padding: "0 0 0 4px", listStyle: "none" }}>
              {insights.map((line, i) => (
                <li key={i} style={{ display: "flex", gap: 10, marginBottom: 12, fontSize: 14, color: t2, lineHeight: 1.5 }}>
                  <span style={{ color: "#9333ea", flexShrink: 0, marginTop: 2 }}>⬡</span>
                  <span>{line}</span>
                </li>
              ))}
            </ul>
            <div style={{ position: "absolute", right: 16, bottom: 48, opacity: 0.12, pointerEvents: "none" }}>
              <TrendingUp size={80} color="#9333ea" />
            </div>
            <a
              href={LEARN_MORE_INSIGHTS_HREF}
              target="_blank"
              rel="noopener noreferrer"
              style={{
                marginTop: 8,
            ...
            >
              Learn more about adherence <ChevronRight size={16} aria-hidden />
            </a>
          </motion.div>

          <motion.div className="au" style={{ ...cardBase, padding: 22 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              <Lightbulb size={22} color="#16a34a" />
              <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: t1 }}>Tips to improve</h3>
            </div>
            <ul style={{ margin: 0, padding: 0, listStyle: "none" }}>
              {ADHERENCE_TIP_RESOURCES.map((tip, i) => (
                <li key={i} style={{ marginBottom: 16, fontSize: 14, color: t2, lineHeight: 1.5 }}>
                  <div style={{ display: "flex", gap: 10 }}>
                    <span style={{ color: "#22c55e", fontWeight: 700, flexShrink: 0 }}>✓</span>
                    <span>{tip.text}</span>
                  </div>
                  <a
                    {...externalLinkProps(tip.href)}
                    style={{
                      display: "inline-flex",
                      alignItems: "center",
                      gap: 4,
            ...
            <a
              {...externalLinkProps(LEARN_MORE_MORE_TIPS_HREF)}
              style={{
                marginTop: 4,
                color: "#16a34a",
                fontWeight: 700,
            ...
            >
              More tips & resources <ChevronRight size={16} aria-hidden />
            </a>
          </motion.div>
        </div>
